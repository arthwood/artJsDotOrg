...
DISQUS.define(function (a, b) {
  ...
  "use strict";
  var a = "default", b = "e101f88f", c = {lounge: "http://disqus.com/embed/comments/", profile: "http://disqus.com/embed/profile/", onboard: "http://disqus.com/embed/onboard/"}, d = function (a, b) {
  ...
  var i = a.document, j = {}, k = DISQUS.use("JSON"), l = DISQUS.isOwn;
  e(a, "message", function (a) {
    var c;
    for (var d in j)if (l(j, d) && a.origin === j[d].origin) {
      c = !0;
      break
    }
    if (c) {
      var e = k.parse(a.data), f = j[e.sender];
  ...
  e(a, "scroll", h(m, 250, 50)), e(i, "click", function () {
    DISQUS.trigger("window.click")
  });
  var n = function (a) {
    a = a || {}, this.state = n.INIT, this.uid = a.uid || DISQUS.getUid(), this.origin = a.origin, this.target = a.target, this.window = null, j[this.uid] = this, this.on("ready", function () {
      this.state = n.READY
    }, this), this.on("die", function () {
      this.state = n.KILLED
    }, this)
  };
  DISQUS.extend(n, {INIT: 0, READY: 1, KILLED: 2}), DISQUS.extend(n.prototype, DISQUS.Events), n.prototype.sendMessage = function (a, b) {
    ...
    this.state = n.KILLED, this.off()
  }, n.prototype.isReady = function () {
    return this.state === n.READY
  }, n.prototype.isKilled = function () {
    return this.state === n.KILLED
  };
  var o = function (a) {
    n.call(this, a), this.windowName = a.windowName
  };
  DISQUS.extend(o.prototype, n.prototype), o.prototype.load = function () {
    this.window = a.open("", this.windowName || "_blank"), this.window.location = this.url()
  }, o.prototype.isKilled = function () {
    return n.prototype.isKilled() || this.window.closed
  };
  var p = function (a) {
    n.call(this, a), this.styles = a.styles || {}, this.tabIndex = a.tabIndex || 0, this.title = a.title || "Disqus", this.container = a.container, this.elem = null
  };
  DISQUS.extend(p.prototype, n.prototype), p.prototype.load = function () {
  ...
  }, p.prototype.getOffset = function (a) {
    return d(this.elem, a)
  }, p.prototype.setInlineStyle = function (a, b) {
    var c = {};
  ...
  }, p.prototype._setInlineStyleCompat = function (a) {
    ...
    return this.elem && this.elem.parentNode && (this.elem.parentNode.removeChild(this.elem), this.elem = null), n.prototype.destroy.call(this)
  };
  var q = function (a) {
    var b = this;
    b.window = null, p.call(b, a), b.styles = DISQUS.extend({width: "100%", border: "none", overflow: "hidden", height: "0"}, a.styles || {})
  };
  DISQUS.extend(q.prototype, p.prototype), q.prototype.load = function (a) {
    var b = this;
    p.prototype.load.call(b);
    var d = b.elem;
    d.setAttribute("width", "100%"), d.setAttribute("src", this.url()), e(d, "load", function () {
      b.window = d.contentWindow, a && a()
    });
    var f = DISQUS.isString(this.container) ? c(this.container) : this.container;
    f.appendChild(d)
  }, q.prototype.destroy = function () {
    return this.window = null, p.prototype.destroy.call(this)
  };
  var r = function (a) {
    p.call(this, a), this.contents = a.contents || "", this.styles = DISQUS.extend({width: "100%", border: "none", overflow: "hidden"}, a.styles || {})
  };
  DISQUS.extend(r.prototype, p.prototype), r.prototype.load = function () {
    p.prototype.load.call(this);
    var a = this.elem;
    ...
    return f && (e = f.offsetHeight + "px", this.setInlineStyle({height: e, "min-height": e, "max-height": e})), this
  }, r.prototype.show = function () {
    this.setInlineStyle("display", "block")
  }, r.prototype.click = function (a) {
    var b = this, c = b.document.body;
    e(c, "click", function (c) {
      a.call(b, c)
    })
  };
  var s = DISQUS.extend({}, DISQUS.Events);
  return{on: s.on, off: s.off, trigger: s.trigger, throttle: h, addEvent: e, removeEvent: f, getOffset: d, postMessage: g, WindowBase: n, Popup: o, Iframe: p, Channel: q, Sandbox: r}
  ...
  var k = j.extend({getUrl: function () {
    ...
    var d = this.settings, e = {permalink: d.permalink, anchorColor: d.anchorColor, referrer: a.location.href, colorScheme: d.colorScheme, typeface: d.typeface, remoteAuthS3: d.remoteAuthS3, apiKey: d.apiKey, sso: d.sso, parentWindowHash: a.location.hash, forceAutoStyles: d.forceAutoStyles, layout: d.layout, timestamp: this.timestamp};
  ...
  var b = a.document, c = ".disqus-loader{animation:disqus-embed-spinner .7s infinite linear;-webkit-animation:disqus-embed-spinner .7s infinite linear}@keyframes disqus-embed-spinner{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}@-webkit-keyframes disqus-embed-spinner{0%{-webkit-transform:rotate(0deg)}100%{-webkit-transform:rotate(360deg)}}", d = "//a.disquscdn.com/next/assets/img/loader-bg.6f0512a11a0d2d3c1a28284486e74f1d.png", e = DISQUS.next.host, f = e.utils, g = e.app.ThreadBoundApp, h = g.extend({name: "lounge", indicators: null, wasInViewport: !1, wasNearViewport: !1, triggeredSlowEvent: !1, events: {beforeInit: function () {
  ...
  }}, onceEvents: {"frame:loadLinkAffiliator": function (b, c) {
    var d = function () {
    ...
    if (!(a.vglnk_self || a.vglnk || d())) {
      ...
      null != b.clientUrl && null != e && null != f && null != b.id && (this.listenForAffiliationRequests(e, f, g), DISQUS.define("vglnk", function () {
        return{api_url: e, key: f, sub_id: g, onlibready: function () {
          c.sendMessage("affiliationOptions", {timeout: DISQUS.vglnk.opt("click_timeout")})
        }}
    ...
    this.on("frame:affiliateLink", function (e) {
      ...
      var g = DISQUS.vglnk.$;
      return g ? void g.request(a + "/click", {format: "jsonp", out: e.url, key: b, loc: d.target, subId: c}, {fn: f(e.token), timeout: DISQUS.vglnk.opt("click_timeout")}) : void d.sendMessage("affiliateLink")
    })
  ...
  var c = DISQUS.use("next.host.utils"), d = function (a, c) {
    this.win = a, this.configurator = c, this.config = {page: {url: b, title: b, slug: b, category_id: b, identifier: b, language: b, api_key: b, remote_auth_s3: b, author_s3: b}, experiment: {enable_scroll_container: b, force_auto_styles: b}, discovery: {disable_all: b, disable_promoted: b}, strings: b, sso: {}, callbacks: {preData: [], preInit: [], onInit: [], afterRender: [], onReady: [], onNewComment: [], preReset: [], onPaginate: [], onIdentify: [], beforeComment: []}}
  };
