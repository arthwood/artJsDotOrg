  ...
  describe("#inject", function() {
    it("should accumulate elements", function() {
      var testObject = {
        ...
        action: function() {
          var value = [ 6, 3 ];
          var result = subject().inject(value, {
            a: 4
          }, this._callback, this);
...
spec(artjs.Object, function() {
  ...
  describe("#map", function() {
    it("should map object to array", function() {
      ...
      var result = subject().map(obj, function(k, v) {
        return k + v;
      });
  ...
  describe("#mapValue", function() {
    it("should change object values", function() {
      ...
      var result = subject().mapValue(obj, function(k, v) {
        return v + 1;
      });
  ...
  describe("#mapKey", function() {
    it("should change object keys", function() {
      ...
      var result = subject().mapKey(obj, function(k) {
        return k + k;
      });
  ...
  describe("#eachValue", function() {
    it("should iterate over items", function() {
      ...
      var result = 0;
      subject().eachValue(obj, function(i) {
        result += i;
      });
      expect(result).to(eq(4));
    });
  ...
  describe("#eachKey", function() {
    it("should iterate over keys", function() {
      ...
      var result = "";
      subject().eachKey(obj, function(i) {
        result += i;
      });
  ...
  describe("#select", function() {
    it("should return filtered array", function() {
      ...
      var result = subject().select(obj, function(v, k) {
        return v > 0;
      });
      expect(artjs.Object.keys(result)).to(eq([ "a", "b" ]));
    });
  ...
  describe("#reject", function() {
    it("should return filtered array", function() {
      ...
      var result = subject().reject(obj, function(i) {
        return i > 0;
      });
