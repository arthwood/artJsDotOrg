...
DISQUS.define(function(a, b) {
  ...
  DISQUS.extend(n, {
    ...
    READY: 1,
    KILLED: 2
  }), DISQUS.extend(n.prototype, DISQUS.Events), n.prototype.sendMessage = function(a, b) {
    var c = k.stringify({
      scope: "client",
      name: a,
      data: b
  ...
  }, n.prototype.hide = function() {}, n.prototype.show = function() {}, n.prototype.url = function() {
  ...
  var q = function(a) {
    var b = this;
    b.window = null, p.call(b, a), b.styles = DISQUS.extend({
      width: "100%",
      border: "none",
      overflow: "hidden",
      height: "0"
  ...
  var r = function(a) {
    p.call(this, a), this.contents = a.contents || "", this.styles = DISQUS.extend({
      width: "100%",
      border: "none",
      overflow: "hidden"
    }, a.styles || {});
  ...
  function o(a) {
    for (var b, c = l(a, "span", "font-family", "fontFamily"), d = c.split(","), e = {
      ...
      palatino: 1,
      serif: 1
    }, f = 0; f < d.length; f++) if (b = n(d[f]), e.hasOwnProperty(b)) return !0;
    return !1;
  }
  function p(a) {
  ...
  "use strict";
  var b = DISQUS.isOwn, c = DISQUS.extend, d = DISQUS.use("next.host"), e = d.urls, f = document.documentElement, g = document.location.protocol, h = {
    ...
    listenForAffiliationRequests: function(a, b, c) {
      ...
      this.on("frame:affiliateLink", function(e) {
        ...
        return g ? void g.request(a + "/click", {
          ...
          fn: f(e.token),
          timeout: DISQUS.vglnk.opt("click_timeout")
        }) : void d.sendMessage("affiliateLink");
      });
    },
