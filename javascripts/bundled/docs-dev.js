    ...
    list: {
      ...
      sections: [ {
        ...
        members: [ {
          ...
          description: 'Adds <span class="code">item</span> to the end of collection and returns new length.' + "<br/>" + 'If <span class="code">noEvent</span> is set to true, this action wont dispatch the <span class="code">change</span> event.',
    ...
    element_builder: {
      ...
      sections: [ {
        ...
        members: [ {
          ...
          example: [ "var builder = new ElementBuilder('span', {class: 'price'}, '$199');" ]
        } ]
      }, {
        name: "Properties",
        members: [ {
