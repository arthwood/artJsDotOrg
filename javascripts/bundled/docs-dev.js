...
art.DB = {
  ...
  content: {
    ...
    object: {
      ...
      sections: [ {
        name: "Static methods",
        members: [ new art.Member("all(object:Object, callback:Function):Boolean", 'Returns true if for all values <span class="code">callback</span> returns true; false otherwise', [ "var object = {color: 'white', id: 5};", "", "artjs.Object.all(object, function(i) {", "  return i !== false;", "}); // true ", "// or ", "// object.all(function(i) {", "  return i !== false;", "});", "", "artjs.Object.all(object, function(i) {", "  return !isNaN(parseInt(i));", "}); // false", "// or", "// object.all(function(i) {", "  return !isNaN(parseInt(i));", "});" ]), new art.Member("copy(object:Object):Object", 'Creates a copy of an <span class="param">object</span>.', [ "var object = {id: 4};", "var copy = artjs.Object.copy(object);", "", "// or", "// var copy = object.copy();", "", "object.id = 5;", "object.id; // 5", "copy.id; // 4" ]), new art.Member("copyProps(source:Object, target:Object):Void", 'Copies properties from <span class="param">source</span> object to <span class="param">target</span> object.', [ "var source = {id: 4};", "var target = {active: true};", "", "artjs.Object.copyProps(source, target);", "", "// or", "// source.copyProps(target);", "", "source; // {id: 4}", "target; // {active: true, id: 4}" ]), new art.Member("each(object:Object, callback:Function):Void", 'Iterates over properties and passes value to <span class="param">callback</span>', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "artjs.Object.each(object, function(i) {", "  alert(i);", "});", "", "// or", "// object.each(function(i) {", "//   alert(i);", "// });" ]), new art.Member("eachKey(object:Object, callback:Function):Void", 'Iterates over properties and passes key to <span class="param">callback</span>', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "artjs.Object.eachKey(object, function(i) {", "  alert(i);", "});", "", "// or", "// object.eachKey(function(i) {", "//   alert(i);", "// });" ]), new art.Member("eachPair(object:Object, callback:Function):Void", 'Iterates over properties and passes key and value to <span class="code">callback</span>', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "artjs.Object.eachPair(object, function(k, v) {", "  alert(k + ' -> ' + v);", "});", "", "// or", "// object.eachPair(function(k, v) {", "//   alert(k + ' -> ' + v);", "// });" ]), new art.Member("isEmpty(object:Object):Boolean", 'Returns true if <span class="code">object</span> has no properties; false otherwise', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var empty = {};", "", "artjs.Object.isEmpty(object); // false", "// or", "// object.isEmpty();", "", "artjs.Object.isEmpty(empty); // true", "// or", "// empty.isEmpty();" ]), new art.Member("extend(target:Object, base:Object):Void", 'Copies properties from <span class="param">base</span> object to <span class="param">target</span> object.' + 'In fact it works the same as <span class="code">copyProps()</span>, the only difference is arguments order.', [ "var base = {id: 4};", "var target = {active: true};", "", "artjs.Object.extend(target, base);", "", "// or", "// target.extend(base);", "", "base; // {id: 4}", "target; // {active: true, id: 4}" ]), new art.Member("fromArray(array:Array):Object", 'Transforms 2-dim <span class="code">array</span> into object', [ "var array = [['color', 'white'], ['id', 5]];", "", "artjs.Object.fromArray(array); // {color: 'white', id: 5}" ]), new art.Member("include(object:Object, item:Object):Boolean", 'Returns true if any <span class="code">object</span> value is equal to <span class="code">item</span>; false otherwise', [ "var object = {color: 'white', id: 5};", "", "artjs.Object.include(object, 5); // true", "// or", "// object.include(5);", "", "artjs.Object.include(object, true); // false", "// or", "// object.include(true);" ]), new art.Member("includeAll(object:Object, subset:Object):Boolean", 'Returns true if all <span class="code">subset</span> values can be found among <span class="code">object</span>\'s values; false otherwise', [ "var object = {color: 'white', id: 5};", "", "artjs.Object.includeAll(object, {color: 'white', id: 5}); // true", "// or", "// object.includeAll({color: 'white', id: 5});", "", "artjs.Object.includeAll(object, {id: 5, name: 'Mike'}); // false", "// or", "// object.includeAll({id: 5, name: 'Mike'});" ]), new art.Member("map(object:Object, callback:Function):Array", 'Maps key and value to Array item using <span class="param">callback</span> function', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var mapped = artjs.Object.map(object, function(k, v) {return k + ':' + v});", "", "// or", "// var mapped = object.map(function(k, v) {return k + ':' + v});", "", "mapped; // ['id:4', 'active:true', 'project_id:4', 'status:4']" ]), new art.Member("mapKey(object:Object, callback:Function):Object", 'Transforms key using <span class="param">callback</span> function', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var mapped = artjs.Object.mapKey(object, function(k) {", "  return artjs.String.capitalizeUnderscored(k);", "});", "", "// or", "// var mapped = object.mapKey(function(k) {", "//   return artjs.String.capitalizeUnderscored(k);", "// });", "", "mapped; // {Id: 8, Active: 2, ProjectId: 8, Status: 8}" ]), new art.Member("mapValue(object:Object, callback:Function):Object", 'Transforms value using <span class="param">callback</span> function', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var mapped = artjs.Object.mapValue(object, function(v) {return v * 2});", "", "// or", "// var mapped = object.mapValue(function(v) {return v * 2});", "", "mapped; // {id: 8, active: 2, project_id: 8, status: 8}" ]), new art.Member("merge(target:Object, base:Object):Object", 'Works the same as extend() but returns modified <span class="param">target</span> object.', [ "var base = {id: 4};", "var target = {active: true};", "", "artjs.Object.merge(target, base); // {active: true, id: 4}", "", "// or", "// target.merge(base);", "", "base; // {id: 4}", "target; // {active: true, id: 4}" ]), new art.Member("reject(object:Object, callback:Function):Object", 'Returns copy of <span class="code">object</span> without properties for which <span class="code">callback</span> returns true', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var filtered = artjs.Object.reject(object, function(i) {", "  return i === true;", "});", "", "// or", "// object.reject(function(i) {", "//   return i === true;", "// });", "", "filtered; // {id: 4, project_id: 4, status: '4'}" ]), new art.Member("removeValue(object:Object, value:Object):Void", 'Removes all <span class="param">object</span>\'s properties with value equal to <span class="param">value</span> param', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "", "artjs.Object.removeValue(object, 4);", "", "// or", "// object.removeValue(4);", "", "object; // {active: true, status: '4'}" ]), new art.Member("removeValues(object:Object, values:Array):Void", 'Works the same as removeValue but you can remove many <span class="param">values</span> by passing them in array', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "", "artjs.Object.removeValues(object, [4, '4']);", "", "// or", "// object.removeValues([4, '4']);", "", "object; // {active: true}" ]), new art.Member("select(object:Object, callback:Function):Object", 'Returns copy of <span class="code">object</span> containing only properties for which <span class="code">callback</span> returns true', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var filtered = artjs.Object.select(object, function(v, k) { ", "  return !isNaN(parseFloat(v));", "});", "", "// or", "// object.select(function(v, k) {", "//   return !isNaN(parseFloat(v));", "// });", "", "filtered; // {id: 4, project_id: 4, status: '4'}" ]), new art.Member("toArray(object:Object):Array", 'Transforms <span class="code">object</span> into array', [ "var object = {color: 'white', id: 5};", "", "artjs.Object.toArray(object); // [['color', 'white'], ['id', 5]]", "// or", "// object.toArray();" ]), new art.Member("toQueryString(object:Object):String", 'Returns query string representation of <span class="code">object</span>', [ "var object = {color: 'white', id: 5, user: {name: 'Andy', id: 3}};", "", "artjs.Object.toQueryString(object);// color=white&id=5&user[name]=Andy&user[id]=3", "// or", "// object.toQueryString()" ]) ]
      } ]
    },
    point: {
      name: "Point",
