  ...
  content: {
    ajax: {
      ...
      sections: [ {
        ...
        members: [ {
          ...
          example: [ "var ajax = new Ajax('/users', {only_active: 1}, artjs.Ajax.Methods.GET);", "", "ajax.onFailure.add(new Delegate(null, onAjaxFailure));", "", "function onAjaxFailure(ajax) {", "  console.log('failure...');", "}", "", "ajax.request();" ]
        }, {
          header: "onSuccess(ajax:Ajax)",
          description: "Dispatched after successful response",
          example: [ "var ajax = new Ajax('/users', {only_active: 1}, artjs.Ajax.Methods.GET);", "", "ajax.onSuccess.add(new Delegate(null, onAjaxSuccess));", "", "function onAjaxSuccess(ajax) {", "  console.log('success!');", "}", "", "ajax.request();" ]
        } ]
      }, {
        name: "Properties",
        members: [ {
        ...
        members: [ {
          ...
          example: [ "var ajax = new Ajax('/users', {only_active: 1}, artjs.Ajax.Methods.GET);", "", "ajax.onSuccess.add(new Delegate(null, onAjaxSuccess));", "", "function onAjaxSuccess(ajax) {", "  console.log(ajax.getResponseText());", "}", "", "ajax.request();" ]
        }, {
    ...
    array: {
      ...
      sections: [ {
        ...
        members: [ {
          ...
          example: [ "var array = artjs.Array.build(4, function(i) { return i * i; });" ]
        }, {
          header: "first():Object",
    ...
    "class": {
      ...
      sections: [ {
        ...
        members: [ new art.Member("ctor:Function", "Reference to constructor function.") ]
      }, {
        name: "Static properties",
        members: [ new art.Member("superclass:Function", "Reference to constructor function of the parent class."), new art.Member("subclasses:Array", "Stores all subclasses of given class.") ]
      }, {
        name: "Hooks",
    ...
    date: {
      ...
      sections: [ {
        name: "Static methods",
        members: [ new art.Member("copy(date:Date):Date", 'Returns <span class="param">date</span> copy', [ "var date = new Date(); // Tue Jun 04 2010 15:41:32 GMT+0200 {}", "var copy = artjs.Date.copy(date);", "", "// or", "// var copy = date.copy();", "", "date.setDate(6);", "date; // Tue Jun 06 2010 15:41:32 GMT+0200 {}", "copy; // Tue Jun 04 2010 15:41:32 GMT+0200 {}" ]), new art.Member("firstDay(date:Date):Number", 'Returns week day of first day in <span class="param">date</span>\'s month (1 means Monday)', [ "var date = new Date(); // Tue Jun 04 2010 15:41:32 GMT+0200 {}", "", "artjs.Date.firstDay(date); // 2", "// or", "// date.firstDay();" ]), new art.Member("fromDMY(dmy:String, separator:String = '/'):Date", 'Parses <span class="param">dmy</span> (&lt;day&gt;/&lt;month&gt;/&lt;year&gt;) expression and returns Date object', [ "var date = artjs.Date.fromDMY('7/10/2003'); // Tue Oct 07 2003 00:00:00 GMT+0200 {}" ]), new art.Member("getDateShifted(date:Date, days:Number):Date", 'Returns date <span class="param">days</span> after (before if negative) <span class="param">date</span>', [ "var date = new Date(); // Tue Jun 07 2010 15:41:32 GMT+0200 {}", "var shifted = artjs.Date.getDateShifted(date, -3); // Tue Jun 04 2010 15:41:32 GMT+0200 {}", "", "// or", "// var shifted = date.getDateShifted(-3);" ]), new art.Member("hmToMinutes(hm:String, separator:String = ':'):Number", 'Parses <span class="param">hm</span> (&lt;hours&gt;:&lt;minutes&gt;) expression and returns Number of minutes', [ "var date = artjs.Date.hmToMinutes('2:15'); // 135" ]), new art.Member("minutesToHM(minutes:Number, separator:String = ':'):String", 'Returns &lt;hours&gt;:&lt;minutes&gt; format for given amount of <span class="param">minutes</span>', [ "var date = artjs.Date.minutesToHM(135); // '2:15'" ]), new art.Member("monthDaysNum(date:Date):Number", 'Returns number of days in <span class="param">date</span>\'s month', [ "var date = new Date(); // Tue Jun 04 2010 15:41:32 GMT+0200 {}", "", "artjs.Date.monthDaysNum(date); // 30", "// or", "// date.monthDaysNum();" ]), new art.Member("msToSeconds(ms:String, separator:String = ':'):Number", 'Parses <span class="param">ms</span> (&lt;minutes&gt;:&lt;seconds&gt;) expression and returns Number of seconds', [ "var date = artjs.Date.msToSeconds('02:15'); // 135" ]), new art.Member("secondsToHMS(seconds:Number, separator:String = ':'):String", 'Returns &lt;hours&gt;:&lt;minutes&gt;:&lt;seconds&gt; format for given amount of <span class="param">seconds</span>', [ "var date = artjs.Date.secondsToMS(4350); // '1:12:30'" ]), new art.Member("secondsToMS(seconds:Number, separator:String = ':'):String", 'Returns &lt;minutes&gt;:&lt;seconds&gt; format for given amount of <span class="param">seconds</span>', [ "var date = artjs.Date.secondsToMS(135); // '02:15'" ]), new art.Member("stripDayTime(date:Date):Date", "Returns date without time part", [ "var date = new Date(); // Tue Jun 07 2010 15:41:32 GMT+0200 {}", "var stripped = artjs.Date.stripDayTime(date); // Tue Jun 07 2010 00:00:00 GMT+0200 {}", "", "// or", "// var stripped = date.stripDayTime();" ]), new art.Member("toDMY(date:Date, separator:String = '/'):String", 'Returns <span class="param">date</span>\'s string representation of day, month, year', [ "var date = new Date(); // Tue Jun 04 2010 15:41:32 GMT+0200 {}", "", "artjs.Date.toDMY(date); // '04/06/2010'", "// or", "// date.toDMY();" ]), new art.Member("toHMS(date:Date, separator:String = ':'):String", 'Returns <span class="param">date</span>\'s string representation of hour, minute, second', [ "var date = new Date(); // Tue Jun 04 2010 15:41:32 GMT+0200 {}", "", "artjs.Date.toHMS(date); // '15:41:32'", "// or", "// date.toHMS();" ]), new art.Member("toYMD(date:Date, separator:String = '/'):String", 'Returns <span class="param">date</span>\'s string representation of year, month, day', [ "var date = new Date(); // Tue Jun 04 2010 15:41:32 GMT+0200 {}", "", "artjs.Date.toYMD(date); // '2010/06/04'", "// or", "// date.toYMD();" ]) ]
      } ]
    },
    date_picker: {
      name: "DatePicker",
    ...
    delegate: {
      ...
      sections: [ {
        ...
        members: [ {
          ...
          example: [ "function onClick(link, e, msg) {", "  console.log('Link clicked! ' + msg);", "  return false;", "}", "", "var delegate = new Delegate(this, onClick, 'hello');", "", "link.onclick = delegate.callback(true);" ]
        } ]
      }, {
        name: "Properties",
        members: [ {
        ...
        members: [ {
          ...
          example: [ "function method(value, message) {", "  console.log('method called! value:' + value + ', message: ' + message);", "  return true;", "}", "", "var delegate = new Delegate(this, method, 'hello');", "var result = delegate.invoke(5); // true" ]
        } ]
      }, {
        name: "Static Methods",
        members: [ {
    ...
    element: {
      ...
      sections: [ {
        name: "Static methods",
        members: [ new art.Member("addClass(element:Element, name:String):Void", 'Adds class identified by <span class="param">name</span> to <span class="param">element</span>' + "(only if it doesn't already have this class)", [ "artjs.Element.addClass(element, 'nav');", "", "// or", "// element.addClass('nav');" ]), new art.Member("center(element:Element):Void", 'Centers <span class="param">element</span> on the screen.' + "This action takes effect only for elements with absolute position.", [ "artjs.Element.center(element);", "", "// or", "// element.center();" ]), new art.Member("centerH(element:Element):Void", 'Centers <span class="param">element</span> horizontally on the screen.' + "This action takes effect only for elements with absolute position.", [ "artjs.Element.centerH(element);", "", "// or", "// element.centerH();" ]), new art.Member("centerV(element:Element):Void", 'Centers <span class="param">element</span> vertically on the screen.' + "This action takes effect only for elements with absolute position", [ "artjs.Element.centerV(element);", "", "// or", "// element.centerV();" ]), new art.Member("clone(element:Element, deep:Boolean):Node", "Alias for Node.cloneNode(deep).", [ "artjs.Element.clone(element, true);", "", "// or", "// element.clone(true);" ]), new art.Member("disable(element:Element):Void", 'Disables the <span class="param">element</span>.', [ "artjs.Element.disable(element);", "", "// or", "// element.disable();" ]), new art.Member("elements(element:Element):Array", 'Returns array of immediate descendants (Elements) of <span class="param">element</span>', [ "artjs.Element.elements(element);", "", "// or", "// element.elements();" ]), new art.Member("enable(element:Element):Void", 'Enables the <span class="param">element</span>', [ "artjs.Element.enable(element);", "", "// or", "// element.enable();" ]), new art.Member("firstElement(element:Element):Element", 'Returns <span class="param">element</span>\'s first child (Element)', [ "artjs.Element.firstElement(element);", "", "// or", "// element.firstElement();" ]), new art.Member("getAttributes(element:Element):Object", "Returns attributes as an Object", [ "artjs.Element.getAttributes(element);", "", "// or", "// element.getAttributes();" ]), new art.Member("getBounds(element:Element, real:Boolean, withoutScroll:Boolean):Rectangle", 'Returns position and size of <span class="param">element</span> as a (x, y, width, height) Rectangle.', [ "artjs.Element.getBounds(element);", "", "// or", "// element.getBounds();" ], null, 'If <span class="param">real</span> is set to true size is calculated even if element is hidden' + "(otherwise size would return value of (0, 0))." + 'If <span class="param">withoutScroll</span> is set to true posision is calculated relative to' + "current view's origin; otherwise to document's origin."), new art.Member("getCenteredPosition(element:Element):Point", 'Returns position of <span class="param">element</span> as if it was centered on the screen', [ "artjs.Element.getCenteredPosition(element);", "", "// or", "// element.getCenteredPosition();" ]), new art.Member("getClasses(element:Element):Array", 'Returns array of <span class="param">element</span>\'s classes', [ "artjs.Element.getClasses(element);", "", "// or", "// element.getClasses();" ]), new art.Member("getContent(element:Element):String", 'Returns content (like innerHTML) of <span class="param">element</span>', [ "artjs.Element.getContent(element);", "", "// or", "// element.getContent();" ]), new art.Member("getDocumentSize():Point", "Returns document size", [ "artjs.Element.getDocumentSize();" ]), new art.Member("getPosition(element:Element, withoutScroll:Boolean):Point", 'Returns position of the <span class="param">element</span> on the screen.', [ "artjs.Element.getPosition(element);", "", "// or", "// element.getPosition();" ], null, 'If <span class="param">withoutScroll</span> is set to true posision is calculated relative to' + "current view's origin; otherwise to document's origin"), new art.Member("getScrollPosition():Point", "Returns scroll (x, y) values as a Point", [ "artjs.Element.getScrollPosition();" ]), new art.Member("getSize(element:Element):Point", 'Returns size of the <span class="param">element</span> as a artjs.math.Point object' + "which x property is width and y property is height", [ "artjs.Element.getSize(element);", "", "// or", "// element.getSize();" ]), new art.Member("getWindowSize():Point", "Returns window size", [ "artjs.Element.getWindowSize();" ]), new art.Member("hasClass(element:Element, name:String):Boolean", 'Returns true if <span class="param">element</span> has class <span class="param">name</span>;' + "false otherwise", [ "artjs.Element.hasClass(element, 'nav');", "", "// or", "// element.hasClass('nav');" ]), new art.Member("hide(element:Element):Void", 'Hides the <span class="param">element</span>', [ "artjs.Element.hide(element);", "", "// or", "// element.hide();" ]), new art.Member("isElement(element:Element):Boolean", 'Returns true if <span class="param">element</span> is Element; false otherwise', [ "artjs.Element.isElement(element);", "", "// or", "// element.isElement();" ]), new art.Member("isHidden(element:Element):Boolean", 'Returns true if the <span class="param">element</span> is hidden; true otherwise', [ "artjs.Element.isHidden(element);", "", "// or", "// element.isHidden();" ]), new art.Member("next(element:Element):Node", 'Returns <span class="param">element</span>\'s next sibling (Element)', [ "artjs.Element.next(element);", "", "// or", "// element.next();" ]), new art.Member("parent(element:Element):Element", 'Returns <span class="param">element</span>\'s parent element', [ "artjs.Element.parent(element);", "", "// or", "// element.parent();" ]), new art.Member("prev(element:Element):Node", 'Returns <span class="param">element</span>\'s previous sibling (Element)', [ "artjs.Element.prev(element);", "", "// or", "// element.prev();" ]), new art.Member("putAfter(element:Element, ref:Node):Node", 'Inserts clone of the <span class="param">element</span> as next sibling of <span class="param">ref</span> node', [ "artjs.Element.putAfter(element, child);", "", "// or", "// element.putAfter(child);" ]), new art.Member("putAtBottom(element:Element, ref:Node):Node", 'Inserts clone of the <span class="param">element</span> as the last child of <span class="param">ref</span> node', [ "artjs.Element.putAtBottom(element, container);", "", "// or", "// element.putAtBottom(container);" ]), new art.Member("putAtTop(element:Element, ref:Node):Node", 'Inserts clone of the <span class="param">element</span> as the first child of <span class="param">ref</span> node', [ "artjs.Element.putAtTop(element, container);", "", "// or", "// element.putAtTop(container);" ]), new art.Member("putBefore(element:Element, ref:Node):Node", 'Inserts clone of the <span class="param">element</span> as previous sibling of <span class="param">ref</span> node', [ "artjs.Element.putBefore(element, child);", "", "// or", "// element.putBefore(child);" ]), new art.Member("remove(element:Element):Node", 'Removes the <span class="param">element</span>', [ "artjs.Element.remove(element);", "", "// or", "// element.remove();" ]), new art.Member("removeClass(element:Element, name:String):Void", 'Removes class identified by <span class="param">name</span> from <span class="param">element</span> (only if it have this class)', [ "artjs.Element.removeClass(element, 'nav');", "", "// or", "// element.removeClass('nav');" ]), new art.Member("replace(element:Element, ref:Node, clone:Boolean):Node", 'Replaces <span class="param">ref</span> with an <span class="param">element</span> ' + '(or its clone if <span class="param">clone</span> is set to true)', [ "artjs.Element.replace(element, oldElement, true);", "", "// or", "// element.replace(oldElement, true);" ]), new art.Member("serialize(element:Element):Object", 'Serializes content of <span class="param">element</span> (usually form) and returns its data as Object', [ "artjs.Element.serialize(element);", "", "// or", "// element.serialize();" ]), new art.Member("setAlpha(element:Element, value:Number):Void", 'Sets <span class="param">element</span>\'s transparency; <span class="param">value</span> 0 means transparent, 1 means opaque', [ "artjs.Element.setAlpha(element, 0.4);", "", "// or", "// element.setAlpha(0.4);" ]), new art.Member("setClass(element:Element, name:String, add:Boolean):Void", 'If <span class="param">add</span> is true it adds, otherwise removes class identified by' + '<span class="param">name</span> to <span class="param">element</span>', [ "artjs.Element.setClass(element, 'nav', true);", "", "// or", "// element.setClass('nav', true);" ]), new art.Member("setContent(element:Element, content:String):Void", 'Sets the content (like innerHTML) of <span class="param">element</span>', [ "artjs.Element.setContent(element, 'hello &lt;span&gt;world&lt;/span&gt;!');", "", "// or", "// element.setContent('hello &lt;span&gt;world&lt;/span&gt;!');" ]), new art.Member("setEnabled(element:Element, enabled:Boolean):Void", 'Enables <span class="param">element</span> if <span class="param">enabled</span> is true; disables otherwise', [ "artjs.Element.setEnabled(element, true);", "", "// or", "// element.setEnabled(true);" ]), new art.Member("setPosition(element:Element, position:Point):Void", 'Sets the position of <span class="param">element</span> on the screen. ' + "This action has effect for elements with absolute position", [ "artjs.Element.setPosition(element, point);", "", "// or", "// element.setPosition(point);" ]), new art.Member("setVisible(element:Element, visible:Boolean):Void", 'Shows the <span class="param">element</span> if <span class="param">visible</span> argument is set to true; hides otherwise', [ "artjs.Element.setVisible(element, true);", "", "// or", "// element.setVisible(true);" ]), new art.Member("setX(element:Element, value:Number):Void", 'Sets x position of <span class="param">element</span> on the screen. ' + "This action has effect for elements with absolute position", [ "artjs.Element.setX(130);", "", "// or", "// element.setX(130);" ]), new art.Member("setY(element:Element, value:Number):Void", 'Sets y position of <span class="param">element</span> on the screen. ' + "This action has effect for elements with absolute position", [ "artjs.Element.setY(130);", "", "// or", "// element.setY(130);" ]), new art.Member("show(element:Element):Void", 'Shows the <span class="param">element</span>', [ "artjs.Element.show(element);", "", "// or", "// element.show();" ]), new art.Member("toggle(element:Element):Void", 'Shows the <span class="param">element</span> if it\'s hidden; hides otherwise', [ "artjs.Element.toggle(element);", "", "// or", "// element.toggle();" ]), new art.Member("toggleClass(element:Element, name:String):Void", 'Toggles class identified by <span class="param">name</span> of <span class="param">element</span>', [ "artjs.Element.toggleClass(element, 'nav');", "", "// or", "// element.toggleClass('nav');" ]) ]
      } ]
    },
    element_builder: {
      name: "ElementBuilder",
    ...
    list: {
      ...
      sections: [ {
        ...
        members: [ {
          ...
          example: [ "var list = new List([1, 2, 3, 4, 5]);", "", "list.onChange.add(new artjs.Delegate(this, this.onChange));", "", "function onChange(list) {", "  'console.log('list has changed!');'", "}" ]
        } ]
      }, {
        name: "Properties",
        members: [ {
    ...
    log: {
      ...
      sections: [ {
        name: "Static methods",
        members: [ new art.Member("log(args...:*):Void", "Uses internally console.log to display messages."), new art.Member("p(args...:*):Void", "Alias method for log().") ]
      } ]
    },
    main: {
      name: "artjs",
      ...
      sections: [ {
        name: "Constants",
        members: [ new art.Member("VERSION:String", "Current version of framework") ]
      }, {
        name: "Methods",
        members: [ new art.Member("$():Element", "Alias for artjs.Element.getElements()", [ "var nav = artjs.$('.main p.item span');" ]), new art.Member("$D():Delegate", "Alias for Delegate.create()", [ "var delegate = artjs.$D(this, this.onClick);" ]), new art.Member("$DC():Function", "Alias for Delegate.callback()", [ "var callback = artjs.$DC(this, this.onClick, true);" ]), new art.Member("$del():Ajax", "Alias for Ajax.del()", [ "var ajax = artjs.$del('http://mydomain.com', {id: 4}, new Delegate(this, this.onAjaxSuccess));" ]), new art.Member("$find():Element", "Alias for artjs.Element.find()", [ "var nav = artjs.$('navigation');", "var item = artjs.$find(nav, '.item');" ]), new art.Member("$findAll():Array", "Alias for artjs.Element.findAll()", [ "var nav = artjs.$('navigation');", "var items = artjs.$findAll(nav, '.item');" ]), new art.Member("$get():Ajax", "Alias for Ajax.get()", [ "var ajax = artjs.$get('http://mydomain.com', null, new Delegate(this, this.onAjaxSuccess));" ]), new art.Member("p():Void", "Debug info. If debug console is accessible output to the console; uses console.log() otherwise.", [ "p('myVariable: ' +  myVariable);" ]), new art.Member("$P():Element", "Alias for ElementBuilder.parse()", [ "var element = artjs.$P('<span class=\"desc\">Blue t-shirt</span>');" ]), new art.Member("$post():Ajax", "Alias for Ajax.post()", [ "var ajax = artjs.$post('http://mydomain.com', {id: 4}, new Delegate(this, this.onAjaxSuccess));" ]), new art.Member("$put():Ajax", "Alias for Ajax.$put()", [ "var ajax = artjs.$put('http://mydomain.com', {id: 4}, new Delegate(this, this.onAjaxSuccess));" ]), new art.Member("$up():Element", "Alias for artjs.Element.up()", [ "var nav = artjs.$('navigation');", "var parent = artjs.$up(nav);" ]) ]
      }, {
        name: "Events",
        members: [ new art.Member("onDocumentLoad", "Triggered when DOM is loaded."), new art.Member("onWindowLoad", "Triggered when whole window is loaded (executes after onDocumentLoad)."), new art.Member("onLibraryLoad", "Triggered when all library templates are loaded (executes after onWindowLoad).") ]
      } ]
    },
    math: {
      name: "artjs.Math",
      ...
      sections: [ {
        name: "Static methods",
        members: [ new art.Member("limit(x:Number, a:Number, b:Number):Number", 'Returns <span class="param">x</span> value limited to [<span class="param">a</span>, <span class="param">b</span>] range', [ "artjs.Math.limit(6, 2, 13); // 6", "artjs.Math.limit(6, 8, 13); // 8", "artjs.Math.limit(6, -2, 3); // 3" ]), new art.Member("sawtooth(x:Number, a:Number, b:Number):Number", 'Returns <span class="param">x</span> value periodically limited to ' + '[<span class="param">a</span>, <span class="param">b</span>] range', [ "artjs.Math.sawtooth(6, 2, 13); // 6", "artjs.Math.sawtooth(6, 8, 13); // 11", "artjs.Math.sawtooth(6, -2, 3); // 1" ]), new art.Member("sgn(x:Number):Number", 'Signum function of <span class="param">x</span>', [ "artjs.Math.sgn(-2); // -1", "artjs.Math.sgn(0); // 0", "artjs.Math.sgn(15); // 1" ]), new art.Member("stairs(x:Number, a:Number, b:Number):Number", '"stairs" function of <span class="param">x</span>', [ "artjs.Math.stairs(6, 2, 4); // 2", "artjs.Math.stairs(6, 1, 2); // 5", "artjs.Math.stairs(6, -1, 1); // 3" ]) ]
      } ]
    },
    object: {
      name: "artjs.Object",
      ...
      sections: [ {
        name: "Static methods",
        members: [ new art.Member("all(object:Object, callback:Function):Boolean", 'Returns true if for all values <span class="code">callback</span> returns true; false otherwise', [ "var object = {color: 'white', id: 5};", "", "artjs.Object.all(object, function(i) {", "  return i !== false;", "}); // true ", "", "artjs.Object.all(object, function(i) {", "  return !isNaN(parseInt(i));", "}); // false" ]), new art.Member("copy(object:Object):Object", 'Creates a copy of an <span class="param">object</span>.', [ "var object = {id: 4};", "var copy = artjs.Object.copy(object);", "", "object.id = 5;", "object.id; // 5", "copy.id; // 4" ]), new art.Member("copyProps(source:Object, target:Object):Void", 'Copies properties from <span class="param">source</span> object to <span class="param">target</span> object.', [ "var source = {id: 4};", "var target = {active: true};", "", "artjs.Object.copyProps(source, target);", "", "source; // {id: 4}", "target; // {active: true, id: 4}" ]), new art.Member("each(object:Object, callback:Function):Void", 'Iterates over properties and passes key and value to <span class="param">callback</span>', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "artjs.Object.each(object, function(k, v) {", "  console.log(k, v);", "});" ]), new art.Member("eachKey(object:Object, callback:Function):Void", 'Iterates over properties and passes key to <span class="param">callback</span>', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "artjs.Object.eachKey(object, function(i) {", "  console.log(i);", "});" ]), new art.Member("eachValue(object:Object, callback:Function):Void", 'Iterates over properties and passes value to <span class="code">callback</span>', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "artjs.Object.eachValue(object, function(v) {", "  console.log(v);", "});" ]), new art.Member("isEmpty(object:Object):Boolean", 'Returns true if <span class="code">object</span> has no properties; false otherwise', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var empty = {};", "", "artjs.Object.isEmpty(object); // false", "artjs.Object.isEmpty(empty); // true" ]), new art.Member("extend(target:Object, base:Object):Void", 'Copies properties from <span class="param">base</span> object to <span class="param">target</span> object.' + 'In fact it works the same as <span class="code">copyProps()</span>, the only difference is arguments order.', [ "var base = {id: 4};", "var target = {active: true};", "", "artjs.Object.extend(target, base);", "", "base; // {id: 4}", "target; // {active: true, id: 4}" ]), new art.Member("fromArray(array:Array):Object", 'Transforms 2-dim <span class="code">array</span> into object', [ "var array = [['color', 'white'], ['id', 5]];", "", "artjs.Object.fromArray(array); // {color: 'white', id: 5}" ]), new art.Member("include(object:Object, item:Object):Boolean", 'Returns true if any <span class="code">object</span> value is equal to <span class="code">item</span>; false otherwise', [ "var object = {color: 'white', id: 5};", "", "artjs.Object.include(object, 5); // true", "artjs.Object.include(object, true); // false" ]), new art.Member("includeAll(object:Object, subset:Object):Boolean", 'Returns true if all <span class="code">subset</span> values can be found among <span class="code">object</span>\'s values; false otherwise', [ "var object = {color: 'white', id: 5};", "", "artjs.Object.includeAll(object, {color: 'white', id: 5}); // true", "artjs.Object.includeAll(object, {id: 5, name: 'Mike'}); // false" ]), new art.Member("map(object:Object, callback:Function):Array", 'Maps key and value to Array item using <span class="param">callback</span> function', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var mapped = artjs.Object.map(object, function(k, v) {return k + ':' + v});", "", "mapped; // ['id:4', 'active:true', 'project_id:4', 'status:4']" ]), new art.Member("mapKey(object:Object, callback:Function):Object", 'Transforms key using <span class="param">callback</span> function', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var mapped = artjs.Object.mapKey(object, function(k) {", "  return artjs.String.capitalizeUnderscored(k);", "});", "", "mapped; // {Id: 8, Active: 2, ProjectId: 8, Status: 8}" ]), new art.Member("mapValue(object:Object, callback:Function):Object", 'Transforms value using <span class="param">callback</span> function', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var mapped = artjs.Object.mapValue(object, function(k, v) {return v * 2});", "", "mapped; // {id: 8, active: 2, project_id: 8, status: 8}" ]), new art.Member("merge(target:Object, base:Object):Object", 'Works the same as extend() but returns modified <span class="param">target</span> object.', [ "var base = {id: 4};", "var target = {active: true};", "", "artjs.Object.merge(target, base); // {active: true, id: 4}", "", "", "base; // {id: 4}", "target; // {active: true, id: 4}" ]), new art.Member("reject(object:Object, callback:Function):Object", 'Returns copy of <span class="code">object</span> without properties for which <span class="code">callback</span> returns true', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var filtered = artjs.Object.reject(object, function(i) {", "  return i === true;", "});", "", "filtered; // {id: 4, project_id: 4, status: '4'}" ]), new art.Member("removeValue(object:Object, value:Object):Void", 'Removes all <span class="param">object</span>\'s properties with value equal to <span class="param">value</span> param', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "", "artjs.Object.removeValue(object, 4);", "", "object; // {active: true, status: '4'}" ]), new art.Member("removeValues(object:Object, values:Array):Void", 'Works the same as removeValue but you can remove many <span class="param">values</span> by passing them in array', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "", "artjs.Object.removeValues(object, [4, '4']);", "", "object; // {active: true}" ]), new art.Member("select(object:Object, callback:Function):Object", 'Returns copy of <span class="code">object</span> containing only properties for which <span class="code">callback</span> returns true', [ "var object = {id: 4, active: true, project_id: 4, status: '4'};", "var filtered = artjs.Object.select(object, function(v, k) { ", "  return !isNaN(parseFloat(v));", "});", "", "filtered; // {id: 4, project_id: 4, status: '4'}" ]), new art.Member("toArray(object:Object):Array", 'Transforms <span class="code">object</span> into array', [ "var object = {color: 'white', id: 5};", "", "artjs.Object.toArray(object); // [['color', 'white'], ['id', 5]]" ]), new art.Member("toQueryString(object:Object):String", 'Returns query string representation of <span class="code">object</span>', [ "var object = {color: 'white', id: 5, user: {name: 'Andy', id: 3}};", "", "artjs.Object.toQueryString(object);// color=white&id=5&user[name]=Andy&user[id]=3" ]) ]
      } ]
    },
    point: {
      name: "Point",
    ...
    queue: {
      ...
      sections: [ {
        ...
        members: [ {
          header: "onChange(list:List)",
          description: "Dispatched every time the collection changes",
          example: [ "var queue = new Queue([1, 2, 3, 4, 5]);", "", "queue.onChange.add(new artjs.Delegate(this, this.onChange));", "", "function onChange(queue) {", "'  console.log('queue has changed!');'", "}" ]
        } ]
      }, {
        name: "Methods",
        members: [ {
    ...
    toggler: {
      ...
      sections: [ {
        name: "Constructor",
        members: [ new art.Member("Toggler(unique:Boolean = nil)", null, null, {
          unique: "if true, events won't be triggered when toggling to the same object."
        }) ]
      }, {
        name: "Properties",
        members: [ new art.Member("unique:Boolean", "The same as in constructor."), new art.Member("current:Object", "Returns current element.") ]
      }, {
        name: "Methods",
        members: [ new art.Member("toggle(element:Object):Void", "Puts a new object into container. The previous one pops out.") ]
      }, {
        name: "Events",
    ...
    "transition/blind": {
      ...
      sections: [ {
        name: "Static methods",
        members: [ new art.Member("blindTo(e:Element, value:Integer, duration:Number = 0.4, type:String = EASE_IN_OUT, delay:Number = 0):Void", 'Smoothly changes the height of element to that given by <span class="param">value</span>.'), new art.Member("blindToggle(e:Element, value:Integer, duration:Number = 0.4, type:String = EASE_IN_OUT, delay:Number = 0):Void", "Does the same as blindTo but only if current element height is zero. " + "Otherwise it makes transition to zero height.") ]
      }, {
        name: "Static properties",
